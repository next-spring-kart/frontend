...
<div align=center>
    <a href="https://github.com/warmachine028/frontend">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="frontend">
    </a>
    <p style="font-family: roboto,calibri,serif; font-size:12pt; font-style:italic"> A good one liner description here </p>
    <a href="https://github.com/warmachine028/frontend/forks">
        <img alt="GitHub forks" src="https://img.shields.io/github/forks/warmachine028/frontend">
    </a>
</div>

# [Frontend](https://github.com/warmachine028/frontend)
...
2. Go to [**Security**](https://github.com/warmachine028/frontend/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/frontend/settings/security_analysis#code_scanning_settings) section in settings.
...
<div align="center">
    <a href="https://github.com/warmachine028/frontend/graphs/contributors">
        <img src="https://contrib.rocks/image?repo=warmachine028/frontend" alt="contributors"/>
    </a>
</div>
...
[License]: https://github.com/warmachine028/frontend/blob/main/LICENSE
